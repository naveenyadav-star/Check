                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6">
                        ...
                        isAuth() ? (
                            ...
                            <>
                            <li>
                                <a href="profile-authentication.html"><i class="flaticon-padlock"></i> Job Provider</a>
                            </li>

                            <li>
                            <a href="logout"><i class="flaticon-user"></i> Log Out</a>
                            ...
                            <>
                            <li>
                                <a href="profile-authentication.html"><i class="flaticon-padlock"></i> User</a>
                            </li>
                             <li>
                                    <a href="logout"><i class="flaticon-user"></i> Log Out</a>
                            </li>
                            ...
                            <li>
                                <a href="register"><i class="flaticon-user"></i> Log In</a>
